        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          ...
          <div className="rounded-3xl bg-white p-7 shadow-sm md:col-span-2">
            ...
            <div className="mt-8 flex h-40 items-end justify-center gap-3">
              <div className="h-12 w-8 rounded-t-lg bg-[#E7E5F5]" />
              <div className="h-20 w-8 rounded-t-lg bg-[#CFCBF4]" />
              <div className="h-32 w-8 rounded-t-lg bg-brand" />
              <div className="h-16 w-8 rounded-t-lg bg-[#B9B4EB]" />
              <div className="h-10 w-8 rounded-t-lg bg-[#E7E5F5]" />
            </div>
          </div>

          {/* Cycle Integration */}
          <div className="flex flex-col justify-between rounded-3xl bg-[#D7F0CB] p-7">
            <LuDroplets size={36} className="text-[#7BA05B]" strokeWidth={1.8} />
            <div className="mt-8">
              <h3 className="text-2xl font-semibold leading-tight text-neutral-900">
                Cycle Integration
              </h3>
          ...
          {/* Burnout Card */}
          <div className="flex flex-col items-center justify-center rounded-3xl bg-[#8D7785] py-12 text-center text-white">
          ...
          <div className="flex items-center justify-center gap-3 rounded-3xl bg-[#24006D] py-12 text-center text-white md:col-span-2">
